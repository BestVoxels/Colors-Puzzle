...
public class TypeFour : MainType
{
    ...
    // Contructor
    public TypeFour(float[] timers, float[] minMax) : base(timers, minMax)
    {
    }
    ...
    private void GenerateChoices()
    {
        ...
        GamePlay.CorrectButton = _amountOfPre[0] == _amountOfPre[1] ? (byte)2 : (byte)1;
    }
}
